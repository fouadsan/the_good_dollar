...
SECRET_KEY = 'django-insecure-$pq(y#8qa=ovi)2fc(q-o4^)3lgtoh63gagaa4azm0^hs0%ec$'
...
MIDDLEWARE = [
    ...
    'main.middleware.ViewersMiddleware'
]

ROOT_URLCONF = 'the_good_dollar.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'shop.template_context.get_context',
            ],
        },
    },
]
